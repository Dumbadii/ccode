/**
 * Author: yyc <yeyuchao@gmail.com>
 * 
 * Solution for Exercise 4-06, Chapter4.
 */
...
#define MATHLIB '1' /* signal that a library function in math.h */
#define VARIABLE '2'
...
int getch(void) /* get a (possible push-back) character */
{ 
